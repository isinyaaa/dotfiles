...
keys.globalkeys = gears.table.join(
    ...
    --awful.key( { superkey, shiftkey }, "Print", function() apps.screenshot("selection") end,
    --    {description = "select area to capture", group = "screenshots"}),
    awful.key( { superkey, shiftkey }, "Print", function() apps.screenshot("clipboard") end,
    ...
    -- Media keys
    awful.key({ superkey, ctrlkey }, "period", function() awful.spawn.with_shell("playerctl -p ncspot next") end,
